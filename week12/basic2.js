...
function initialize()
{
	...
	let texture = loader.load( '../assets/cube1.png' );
		
	let patternArray = ["pattern-letterA", "pattern-letterB", "pattern-letterC", "pattern-letterD", "pattern-letterF", "pattern-kanji", "pattern-hiro"];
